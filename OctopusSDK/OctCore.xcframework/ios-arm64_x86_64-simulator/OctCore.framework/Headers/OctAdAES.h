...
@interface OctAdAES : NSObject

+ (NSString *)OctAdAESEncrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
...
+ (NSString *)OctAdAESDecrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSData *)OctAdAESEncryptData2:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSString *)OctAdAESEncryptData:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
//+ (NSString *)OctAdAESDecryptData:(NSData *)originalData
//                      mode:(MIUMode)mode
//                       key:(NSString *)key
//                   keySize:(MIUKeySizeAES)keySize
//                        iv:(NSString * _Nullable )iv
